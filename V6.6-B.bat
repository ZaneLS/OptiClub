...
:: 2
echo Disabling taskbar animations (Default value = 1)
...
powershell Invoke-WebRequest "https://raw.githubusercontent.com/ZaneLS/Configs/refs/heads/main/OptiClub-Soft.bat" -OutFile "%temp%\OptiClub-Soft.bat"
start "" /wait "%temp%\OptiClub-Soft.bat
echo Done
...
powershell Invoke-WebRequest "https://github.com/ZaneLS/Configs/raw/refs/heads/main/OptiClub-Aggressive.bat" -OutFile "%temp%\OptiClub-Aggressive.bat"
start "" /wait "%temp%\OptiClub-Aggressive.bat
...
powershell Invoke-WebRequest "https://github.com/ZaneLS/Configs/raw/refs/heads/main/OpticlubDefault.bat" -OutFile "%temp%\OpticlubDefault.bat"
start "" /wait "%temp%\OpticlubDefault.bat
...
powershell Invoke-WebRequest "https://github.com/ZaneLS/Configs/raw/refs/heads/main/OptiClub-Safe-Aggressive.bat" -OutFile "%temp%\OptiClub-Safe-Aggressive.bat"
start "" /wait "%temp%\OptiClub-Safe-Aggressive.bat
