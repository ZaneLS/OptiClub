...
reg add "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\Class\{4d36e968-e325-11ce-bfc1-08002be10318}\0000" /v "Main3D" /t REG_BINARY /d "3000" /f
reg add "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\Class\{4d36e968-e325-11ce-bfc1-08002be10318}\0000\UMD" /v "Main3D" /t REG_BINARY /d "3000" /f
reg add "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\Class\{4d36e968-e325-11ce-bfc1-08002be10318}\0000\UMD" /v "Main3D_DEF" /t REG_SZ /d "0" /f
reg add "HKCU\Software\AMD\CN" /v "AllowWebContent" /t REG_SZ /d "false" /f
reg add "HKCU\Software\AMD\CN" /v "AnimationEffect" /t REG_SZ /d "false" /f
...
echo.
echo.
echo				%w%[%y% %c%%u%1%q%%t% %w%]%y% %c%Aggressive CFG%t%
echo.
echo				%w%[%y% %c%%u%2%q%%t% %w%]%y% %c%Default CFG%t%
echo.
...
schtasks /Change /TN "BraveSoftwareUpdateTaskMachineCore{07DC0B7B-BD2B-408A-AB0A-98711C326133}" /Enable  
schtasks /Change /TN "BraveSoftwareUpdateTaskMachineUA{D845BBBA-3F78-4C64-A41C-DB008DB9666C}" /Enable  
schtasks /Change /TN "MicrosoftEdgeUpdateTaskMachineCore{076114C9-FCF8-44A9-8E5E-BBBC8DE18AF9}" /Enable  
schtasks /Change /TN "MicrosoftEdgeUpdateTaskMachineUA{60E884DC-2F1D-4E4A-88A9-196D8BE5E059}" /Enable   
...
icacls "C:\Program Files (x86)\Microsoft\EdgeUpdate\MicrosoftEdgeUpdate.exe" /deny Everyone:(X)
schtasks /Change /TN "BraveSoftwareUpdateTaskMachineCore{07DC0B7B-BD2B-408A-AB0A-98711C326133}" /Disable  
schtasks /Change /TN "BraveSoftwareUpdateTaskMachineUA{D845BBBA-3F78-4C64-A41C-DB008DB9666C}" /Disable  
schtasks /Change /TN "MicrosoftEdgeUpdateTaskMachineCore{076114C9-FCF8-44A9-8E5E-BBBC8DE18AF9}" /Disable   
schtasks /Change /TN "MicrosoftEdgeUpdateTaskMachineUA{60E884DC-2F1D-4E4A-88A9-196D8BE5E059}" /Disable   
echo done
pause
goto Menu
